namespace Streebog
{
    static public class Streebog
    {
        ...
        private static readonly byte[] nullBytes = Enumerable.Repeat(0, sizeInput).Select(x => (byte)x).ToArray();
        public static byte[] HashFunc(byte[] data, OutSize size, TypeInput typeInput)
        {
            ...
            for (int i = 1; i <= n; i++)
            {
                ...
                data = data.SkipLast(sizeInput).ToArray();
            }
